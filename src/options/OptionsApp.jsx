...
const OptionsApp = () => {
  ...
  const exportData = async () => {
    try {
      ...
      if (response.success) {
        ...
        a.href = url
        a.download = `autopassfiller-backup-${
  ...
  const importData = async (event) => {
    ...
    try {
      ...
      if (response.success) {
        showNotification("数据导入成功，已添加到现有数据", "success")
        await loadStats()
      } else {
                ...
                <div className="flex items-center justify-between">
                  ...
                  <label className="relative inline-flex items-center cursor-pointer">
                    <input
                      ...
                      onChange={(e) =>
                        handleSettingChange("autoLock", e.target.checked)
                      }
                      disabled={saving}
                    />
                    <div className="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-primary-300 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-primary-600"></div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <label className="relative inline-flex items-center cursor-pointer">
                    <input
                      ...
                      onChange={(e) =>
                        handleSettingChange("autoFill", e.target.checked)
                      }
                      disabled={saving}
                    />
                    <div className="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-primary-300 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-primary-600"></div>
          ...
          <div className="space-y-6">
            ...
            <div className="card p-6">
              ...
              <div className="space-y-2 text-sm text-gray-600">
                ...
                <p>
                  <strong>加密:</strong> AES-256-GCM
                </p>
                <p>
                  <strong>存储:</strong> 本地加密存储
                </p>
              </div>
