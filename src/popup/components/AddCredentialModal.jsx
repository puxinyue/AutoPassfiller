...
const AddCredentialModal = ({ defaultDomain, onSave, onClose }) => {
      ...
      <div className="modal slide-up dark:bg-gray-800 dark:border-gray-700">
        <div className="modal-header dark:border-gray-700">
          <div className="flex items-center justify-between">
            <h2 className="text-lg font-semibold text-gray-900 dark:text-white">添加新密码</h2>
            <button
              onClick={onClose}
        ...
        <div className="modal-footer dark:border-gray-700">
          ...
          <button
            ...
            disabled={loading || !formData.domain.trim() || !formData.username.trim() || !formData.password.trim()}
          >
            {loading ? (
